...
#### Rural vs. urban, and proximity to farmland

##### Exploratory map of rural-urban continuum classification, and proportion of county in agriculture
...
ruc_pal <- colorFactor(
  palette = as.vector(paletteer_d("MoMAColors::Picabia"))[1:9], 
...
#   addTiles() %>%
  ...
  addLegend(
    ...
    colors = as.vector(paletteer_d("MoMAColors::Picabia"))[1:9],
