...
plot_creator <- function(pc_n) {
  ...
  theme(
    ...
    plot.margin = margin(t = 60,  # Top margin
                         r = 0,  # Right margin
                         b = 0,  # Bottom margin
                         l = 0)
  )
  ...
  cdf %>%
    ...
    tableGrob(
      theme=ttheme_minimal(
        ...
        core = list(padding=unit(c(1, 3), "mm"))
      ), 
      rows=NULL
      )
}
...
#       "  
#   
# wrap_plots(p1, t1, p2, t2, p3, t3, p4, t4, p5, t5, p6, t6,
#            p7, t7, p8, t8, p9, t9, p10, t10, design = plot_layout)
...
wrap_plots(p1, t1, design = plot_design)
...
The regression looks something like the following:
