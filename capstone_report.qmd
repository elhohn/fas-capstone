...
p3 <- fviz_contrib(res.pca, choice = "var", axes = 3, top = 10)
p4 <- fviz_contrib(res.pca, choice = "var", axes = 4, top = 10)
p5 <- fviz_contrib(res.pca, choice = "var", axes = 5, top = 10)
p6 <- fviz_contrib(res.pca, choice = "var", axes = 6, top = 10)
p7 <- fviz_contrib(res.pca, choice = "var", axes = 7, top = 10)
p8 <- fviz_contrib(res.pca, choice = "var", axes = 8, top = 10)
p9 <- fviz_contrib(res.pca, choice = "var", axes = 9, top = 10)
p10 <- fviz_contrib(res.pca, choice = "var", axes = 10, top = 10)
...
d2 <- d %>%
  merge(lamp_by_county2, by.x = 0, by.y = 'fips') %>%
...
new_vars <- c(
  ...
  "Broadband access",
  "% of acres under easement",
  "Creative industry",
  "Jobs in the arts"
  )

                      "deposits"
[10] "ed_attain"                         "est_CBP"                           "food_secure"
[13] "foodbev_est_CBP"                   "health_factors"                    "health_outcomes"
[16] "highway_km"                        "insured"                           "localgovfin"
[19] "museums"                           "natamen_scale"                     "nccs"
[22] "owner_occupied"                    "pc1b_manufacturing"                "pc1c_artsdiversity"
[25] "pc1f"                              "pc1h_healtheducation"              "pc1n_naturalamenitiesconservation"
[28] "pc1s_nonprofitsocialindustries"    "pc2b_infrastructure"               "pc2c_creativeindustries"
[31] "pc2h_medicalfoodsecurity"          "pc2n_farmland"                     "pc2s_publicvoiceparticipation"
[34] "primary_care"                      "prime_farmland"                    "pub_lib"
[37] "pvote"                             "racial_div"                        "respn"
[40] "poverty_rate"                      "ag_proportion"
...
p <- ggplot(d3 %>% filter(variable != "Award.Amount") %>% ungroup(),
