...
subsetter <- function(topic) {
  d <- comm_wealth %>%
    ...
    select(fips, year, variable_name, value, county_name) %>%
    group_by(fips, variable_name, county_name) %>%
...
# pal_generator <- function(d, pal = 'YlOrRd') {
#   return(colorBin(palette = pal, domain = d$overall, bins = bins))
# }
...
leaflet() %>%
  ...
  #   group = "Food Processors") %>%
  addLegend(
    "bottomleft", 
    pal = pal_generator(natural), 
    opacity = 1,
    values = natural$overall,
    title = 'Natural Resources Index Score',
    group = "nature") %>%
  addLegend(
    "bottomleft", 
    ...
    title = 'Agricultural Resources Index Score',
    group = "ag") %>%
  # addLegend(
  #   "bottomright", 
  ...
  #   title = 'Food Processors Index Score',
  #   group = "Food Processors") %>%
  # addLegend(
  #   "bottomright", 
  ...
  #   opacity = 1,
  #   values = food_processors$overall,
  #   title = 'Infrastructure Index Score',
  #   group = "Infrastructure") %>%
  # addLegend(
  #   "bottomright", 
  ...
  #   title = 'Food Insecurity Index Score',
  #   group = "Food Insecurity") %>%
  # addLegend(
  #   "bottomright", 
